...
type TickerBeatsServiceClient interface {
	...
	ConfirmBeatsTransaction(ctx context.Context, in *TickerBeatsConfirmationRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *tickerBeatsServiceClient) ConfirmBeatsTransaction(ctx context.Context, in *TickerBeatsConfirmationRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type TickerBeatsServiceServer interface {
	...
	ConfirmBeatsTransaction(context.Context, *TickerBeatsConfirmationRequest) (*empty.Empty, error)
...
type TransactionsServiceClient interface {
	...
	// Creates a new deal
	CreateDeals(ctx context.Context, in *CreateDealsRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// Creates a new order
	CreateOrders(ctx context.Context, in *CreateOrdersRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// Creates a new position
	CreatePositions(ctx context.Context, in *CreatePositionsRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// Creates a trade transation
	CreateTradeTransaction(ctx context.Context, in *CreateTradeTransactionRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *transactionsServiceClient) CreateAccount(ctx context.Context, in *CreateAccountRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *transactionsServiceClient) CreateDeals(ctx context.Context, in *CreateDealsRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *transactionsServiceClient) CreateOrders(ctx context.Context, in *CreateOrdersRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *transactionsServiceClient) CreatePositions(ctx context.Context, in *CreatePositionsRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *transactionsServiceClient) CreateTradeTransaction(ctx context.Context, in *CreateTradeTransactionRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type TransactionsServiceServer interface {
	...
	// Creates a new deal
	CreateDeals(context.Context, *CreateDealsRequest) (*empty.Empty, error)
	// Creates a new order
	CreateOrders(context.Context, *CreateOrdersRequest) (*empty.Empty, error)
	// Creates a new position
	CreatePositions(context.Context, *CreatePositionsRequest) (*empty.Empty, error)
	// Creates a trade transation
	CreateTradeTransaction(context.Context, *CreateTradeTransactionRequest) (*empty.Empty, error)
...
func (c *testingStatisticsServiceClient) Create(ctx context.Context, in *CreateTestingStatisticsRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/tickerbeats.v1.TestingStatisticsService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TestingStatisticsServiceServer interface {
	Create(context.Context, *CreateTestingStatisticsRequest) (*empty.Empty, error)
...
func _TestingStatisticsService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tickerbeats.v1.TestingStatisticsService/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
