...
type TradeTransaction struct {
	...
	TransactionId   uint64                 `protobuf:"varint,1,opt,name=transaction_id,json=transactionId,proto3" json:"transaction_id,omitempty"`                                  // Trade Transaction ID
	Deal            uint64                 `protobuf:"varint,2,opt,name=deal,proto3" json:"deal,omitempty"`                                                                         // Deal ticket
	...
	TradeType       TradeTransactionType   `protobuf:"varint,5,opt,name=trade_type,json=tradeType,proto3,enum=mql5_background.v1.TradeTransactionType" json:"trade_type,omitempty"` // Trade transaction type
	OrderType       OrderType              `protobuf:"varint,6,opt,name=order_type,json=orderType,proto3,enum=mql5_background.v1.OrderType" json:"order_type,omitempty"`            // Order type
	OrderState      OrderState             `protobuf:"varint,7,opt,name=order_state,json=orderState,proto3,enum=mql5_background.v1.OrderState" json:"order_state,omitempty"`        // Order state
	DealType        DealType               `protobuf:"varint,8,opt,name=deal_type,json=dealType,proto3,enum=mql5_background.v1.DealType" json:"deal_type,omitempty"`                // Deal type
	TimeType        OrderTypeTime          `protobuf:"varint,9,opt,name=time_type,json=timeType,proto3,enum=mql5_background.v1.OrderTypeTime" json:"time_type,omitempty"`           // Order type by action period
	TimeExpiration  int64                  `protobuf:"varint,10,opt,name=time_expiration,json=timeExpiration,proto3" json:"time_expiration,omitempty"`                              // Order expiration time
	...
	PositionBy      uint64                 `protobuf:"varint,17,opt,name=position_by,json=positionBy,proto3" json:"position_by,omitempty"`                                          // Ticket of an opposite position
...
func (x *TradeTransaction) GetTransactionId() uint64 {
	if x != nil {
...
func (x *TradeTransaction) GetCreated() *timestamppb.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *TradeTransaction) GetUpdated() *timestamppb.Timestamp {
	if x != nil {
		return x.Updated
	}
	return nil
...
func (x *TradeTransaction) GetDeleted() *timestamppb.Timestamp {
	if x != nil {
		return x.Deleted
	}
	return nil
...
type TradeRequest struct {
	...
	RequestId      uint64                 `protobuf:"varint,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`                                                 // Request ID
	Action         TradeRequestActions    `protobuf:"varint,2,opt,name=action,proto3,enum=mql5_background.v1.TradeRequestActions" json:"action,omitempty"`                            // Trade operation type
	Magic          uint64                 `protobuf:"varint,3,opt,name=magic,proto3" json:"magic,omitempty"`                                                                          // Expert Advisor ID (magic number)
	Order          uint64                 `protobuf:"varint,4,opt,name=order,proto3" json:"order,omitempty"`                                                                          // Order ticket
	Symbol         string                 `protobuf:"bytes,5,opt,name=symbol,proto3" json:"symbol,omitempty"`                                                                         // Trade symbol
	Volume         float64                `protobuf:"fixed64,6,opt,name=volume,proto3" json:"volume,omitempty"`                                                                       // Requested volume for a deal in lots
	Price          float64                `protobuf:"fixed64,7,opt,name=price,proto3" json:"price,omitempty"`                                                                         // Price
	Stoplimit      float64                `protobuf:"fixed64,8,opt,name=stoplimit,proto3" json:"stoplimit,omitempty"`                                                                 // StopLimit level of the order
	...
	Deviation      uint64                 `protobuf:"varint,11,opt,name=deviation,proto3" json:"deviation,omitempty"`                                                                 // Maximal possible deviation from the requested price
	OrderType      OrderType              `protobuf:"varint,12,opt,name=order_type,json=orderType,proto3,enum=mql5_background.v1.OrderType" json:"order_type,omitempty"`              // Order type
	TypeFilling    OrderFillingType       `protobuf:"varint,13,opt,name=type_filling,json=typeFilling,proto3,enum=mql5_background.v1.OrderFillingType" json:"type_filling,omitempty"` // Order execution type
	TypeTime       OrderTypeTime          `protobuf:"varint,14,opt,name=type_time,json=typeTime,proto3,enum=mql5_background.v1.OrderTypeTime" json:"type_time,omitempty"`             // Order expiration type
	TimeExpiration int64                  `protobuf:"varint,15,opt,name=time_expiration,json=timeExpiration,proto3" json:"time_expiration,omitempty"`                                 // Order expiration time (for the orders of ORDER_TIME_SPECIFIED type)
	Comment        string                 `protobuf:"bytes,16,opt,name=comment,proto3" json:"comment,omitempty"`                                                                      // Order comment
	Position       uint64                 `protobuf:"varint,17,opt,name=position,proto3" json:"position,omitempty"`                                                                   // Position ticket
	PositionBy     uint64                 `protobuf:"varint,18,opt,name=position_by,json=positionBy,proto3" json:"position_by,omitempty"`                                             // The ticket of an opposite position
...
func (x *TradeRequest) GetRequestId() uint64 {
	if x != nil {
		return x.RequestId
	}
	return 0
...
func (x *TradeRequest) GetAction() TradeRequestActions {
	...
	return TradeRequestActions_TRADE_ACTION_DEAL
}
...
func (x *TradeRequest) GetCreated() *timestamppb.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *TradeRequest) GetUpdated() *timestamppb.Timestamp {
	if x != nil {
		return x.Updated
	}
	return nil
...
func (x *TradeRequest) GetDeleted() *timestamppb.Timestamp {
	if x != nil {
		return x.Deleted
	}
	return nil
...
type TradeResult struct {
	...
	ResultId        uint64                 `protobuf:"varint,1,opt,name=result_id,json=resultId,proto3" json:"result_id,omitempty"`                       // Result ID
	Retcode         uint32                 `protobuf:"varint,2,opt,name=retcode,proto3" json:"retcode,omitempty"`                                         // Operation return code
	Deal            uint64                 `protobuf:"varint,3,opt,name=deal,proto3" json:"deal,omitempty"`                                               // Deal ticket, if it is performed
	Order           uint64                 `protobuf:"varint,4,opt,name=order,proto3" json:"order,omitempty"`                                             // Order ticket, if it is placed
	Volume          float64                `protobuf:"fixed64,5,opt,name=volume,proto3" json:"volume,omitempty"`                                          // Deal volume, confirmed by broker
	Price           float64                `protobuf:"fixed64,6,opt,name=price,proto3" json:"price,omitempty"`                                            // Deal price, confirmed by broker
	...
	RequestId       uint32                 `protobuf:"varint,10,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`                   // Request ID set by the terminal during the dispatch
...
func (x *TradeResult) GetResultId() uint64 {
	if x != nil {
		return x.ResultId
	}
	return 0
...
func (x *TradeResult) GetCreated() *timestamppb.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *TradeResult) GetUpdated() *timestamppb.Timestamp {
	if x != nil {
		return x.Updated
	}
	return nil
...
func (x *TradeResult) GetDeleted() *timestamppb.Timestamp {
	if x != nil {
		return x.Deleted
	}
	return nil
...
var file_tradetransaction_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xed, 0x06, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x64, 0x65,
	...
	,
	...
	,
	...
	0x65, 0x78, 0x70, 0x69, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03,
	...
	0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0c, 0x70,
	0x72, 0x69, 0x63, 0x65, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x12, 0x26, 0x0a, 0x0f, 0x70,
	0x72, 0x69, 0x63, 0x65, 0x5f, 0x73, 0x74, 0x6f, 0x70, 0x5f, 0x6c, 0x6f, 0x73, 0x73, 0x18, 0x0d,
	...
	,
	...
	0x64, 0x61, 0x74, 0x65, 0x64, 0x18, 0x13, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69,
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64,
	0x12, 0x34, 0x0a, 0x07, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x18, 0x14, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x07, 0x64,
	0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x22, 0xc3, 0x06, 0x0a, 0x0c, 0x54, 0x72, 0x61, 0x64, 0x65,
	...
	0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x12, 0x3f, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x27, 0x2e, 0x6d, 0x71, 0x6c, 0x35, 0x5f, 0x62, 0x61,
	0x63, 0x6b, 0x67, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x72, 0x61, 0x64,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x6d, 0x61, 0x67, 0x69, 0x63, 0x12, 0x14, 0x0a,
	0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x6f, 0x72,
	0x64, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x18, 0x05, 0x20,
	...
	,
	...
	,
	...
	0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x01, 0x52, 0x03, 0x62, 0x69, 0x64, 0x12, 0x10, 0x0a,
	0x03, 0x61, 0x73, 0x6b, 0x18, 0x08, 0x20, 0x01, 0x28, 0x01, 0x52, 0x03, 0x61, 0x73, 0x6b, 0x12,
	...
	0x75, 0x65, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x72,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x12, 0x29, 0x0a, 0x10, 0x72, 0x65, 0x74, 0x63,
	0x6f, 0x64, 0x65, 0x5f, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x18, 0x0b, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0f, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x45, 0x78, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x6c, 0x12, 0x34, 0x0a, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x18, 0x0c,
	...
	,
}
...
var file_tradetransaction_proto_depIdxs = []int32{
	...
	9,  // 5: mql5_background.v1.TradeTransaction.created:type_name -> google.protobuf.Timestamp
	9,  // 6: mql5_background.v1.TradeTransaction.updated:type_name -> google.protobuf.Timestamp
	9,  // 7: mql5_background.v1.TradeTransaction.deleted:type_name -> google.protobuf.Timestamp
	0,  // 8: mql5_background.v1.TradeRequest.action:type_name -> mql5_background.v1.TradeRequestActions
	5,  // 9: mql5_background.v1.TradeRequest.order_type:type_name -> mql5_background.v1.OrderType
	10, // 10: mql5_background.v1.TradeRequest.type_filling:type_name -> mql5_background.v1.OrderFillingType
	8,  // 11: mql5_background.v1.TradeRequest.type_time:type_name -> mql5_background.v1.OrderTypeTime
	9,  // 12: mql5_background.v1.TradeRequest.created:type_name -> google.protobuf.Timestamp
	9,  // 13: mql5_background.v1.TradeRequest.updated:type_name -> google.protobuf.Timestamp
	9,  // 14: mql5_background.v1.TradeRequest.deleted:type_name -> google.protobuf.Timestamp
	9,  // 15: mql5_background.v1.TradeResult.created:type_name -> google.protobuf.Timestamp
	9,  // 16: mql5_background.v1.TradeResult.updated:type_name -> google.protobuf.Timestamp
	9,  // 17: mql5_background.v1.TradeResult.deleted:type_name -> google.protobuf.Timestamp
